...
import com.comparators.DobAndRegnAmt;
	...
	public static void main(String[] args) {
		...
		try(Scanner sc = new Scanner(System.in)) {
			...
			while(!exit) {
				...
				System.out.println("8. Sort via email (desc)");
				...
				try {
					...
					case 7: // dispall with adhar card location
						...
						break;
					case 8: // email desc
						System.out.println("Sorting vehicles via email - desc");
					...
					case 9: // email desc
						System.out.println("Sorting vehicles via email - desc");
						// Collections.sort(customers, new DobAndRegnAmt());
