...
public class Vehicle {
	...
	public Vehicle(String chasisNo, Color color) {
		this.chasisNo=chasisNo;
		this.color = color;
	}
	...
	public boolean equals(Object o) {
		...
		if (o instanceof Vehicle)
			return (this.chasisNo.equals(((Vehicle) o).chasisNo) && this.color.name().equals(((Vehicle)o).color.name())) ;
		// String's equals method for : checking content
																// equality
