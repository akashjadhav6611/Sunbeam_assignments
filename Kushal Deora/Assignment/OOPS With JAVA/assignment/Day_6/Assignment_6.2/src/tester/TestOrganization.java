...
do {
	...
	case 3:
		...
		for(Emp e1:e)
		{
			...
			{
				System.out.println("Net Salary: "+((Mgr) e1).netSalary()+" Performance Bonus:"+((Mgr)e1).getPerformanceBonus());
				
			}
			else
			{
				System.out.println("Net Salary: "+((Worker) e1).netSalary()+" Hourly Rate:"+((Worker)e1).getHourlyRate());
			}
			}
		}
		break;
