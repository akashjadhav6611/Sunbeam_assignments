...
public class FruitBasket {
	...
	public static void main(String[] args) {
		...
		while(ch != 10) {
			...
			System.out.println("6.(Stale) Taste 7.Mark Stale Fruit 8.Mark All Sour Stale 9.Display Special Functionality 10.Exit");
		...
		/// Special Functionality Case
				
			case 9:
				System.out.println("Enter the Index of Fruit: ");
			    index = sm.nextInt() - 1;
				if(index >= 0 && index < fruitn.length) {
					
					Fruit f = fruitn[index];
